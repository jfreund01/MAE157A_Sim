...
rocket = Rocket(first_ ...
    stage_dry_mass, second_stage_dry_mass, ...
    first_stage_motor, second_stage_motor, diameter, area, two_stage, ...
     C_d_first, C_d_second, C_d_parachute, parachute_diameter); % create rocket
...
plot(state_list.time_list, state_list.y_pos_list, LineWidth=1.25, DisplayName='C_d = 0.5')
title('Height (m) vs. time (s)')
...
plot(state_list.time_list, state_list.y_pos_list, LineWidth=1.25, DisplayName='C_d = 0.8')
title('Height (m) vs. time (s)')
legend();
